  ...
  dibujar() {
    ...
    if (this.estado === 0) {
      ...
      for (let i = 0; i < this.vidas; i++) {
        let corazonX = 30 + i * 40; // posición horizontal de cada corazón
        let corazonY = 30;         // Posición fija
        let corazontamaño = 30;    // Tamaño
        image(imgcorazon, corazonX, corazonY, corazontamaño, corazontamaño);
      }
